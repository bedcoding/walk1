 ...
 */
                    ...
                    if (mGoogleApiClient != null) {
                        ...
                        AddLoggedInRecordRequest request = new AddLoggedInRecordRequest(userID, stepsRecord, distanceRecord, calRecord, timeRecord, speedRecord, responseListener);
    ...
    public double getCalorieRate() {
        ...
        double calorieRate = 55.511;//0.00
       /* String savedNormalWeight = SavedSharedPreference.getNormalModeWeight(LoggedInWalk.this);
        ...
        if(savedNormalWeight.length()==0){
            ...
            if(SavedSharedPreference.getNormalModeWeightType(LoggedInWalk.this).trim().equals("lbs")){
